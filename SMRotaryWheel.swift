...
class SMRotaryWheel: UIControl {
	...
	override func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
		...
		delegate?.wheelDidChangeValue(to: currentSector + minimumValue)
...
//		UIView.commitAnimations()
	...
	func setup() {
		...
		// Put the wheel view modifications here
		...
		for i in 0..<numberOfSections {
			...
			let view = delegate.viewFor(tag: i, minimumValue: minimumValue, multiplier: multipier)
